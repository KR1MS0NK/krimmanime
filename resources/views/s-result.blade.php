...
<html>
    ...
    <body class="mainstyle">
        ...
        <div class="bodystyle">
         ...
         <table class="words table-table-hover">
             <thead>
              <tr>
                  <th class="words">Results</th>
              </tr>
             </thead>
             <tbody>
                ...
                @foreach($result as $result)
                   <tr>
                       <td class="words">
                         <a class="navbar-brand words" href="/anime-list/{{$result->id}}">
                           {{ $result->name }}
                         </a>
                       </td>
                   </tr>
                 ...
                 @else
                  ...
                  <tr><td clas="navbar-brand words">Nothing Found</td></tr>
