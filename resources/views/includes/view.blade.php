    ...
    <body class="mainstyle">
        ...
        <div class="bodystyle words" >
         ...
         @foreach($result as $anime )
          ...
          <div class="container fotway">

            <div class=" row ">
              <div class="col wor">
               <img src="/uploads/{{$anime->image}} " alt="img" class="img-fluid rounded mx-auto d-block" />         
              </div>

              <div class="col present">
                  
                <div class=" row wor align-items-top ">
                  <div class="col">
                    <div><h4>{{$anime->name}}</h4></div>
                  </div>              
                </div>

               <div class=" row wor align-items-centre"> 
                 <div class="col wor">
                  <h6>{{$anime->describe}}</h6>
                 </div>
               </div>

                <div class="row wor align-items-end">
                  <div class="col wor">
                   <a href="{{$anime->dlink}}"><button class="btn btn-outline-danger">Download</button></a>
                  </div>
                </div>
